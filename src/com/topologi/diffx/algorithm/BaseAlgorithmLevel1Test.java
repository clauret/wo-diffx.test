...
import com.topologi.diffx.action.Action;
import com.topologi.diffx.action.ActionFormatter;
import com.topologi.diffx.action.ActionsUtils;
import com.topologi.diffx.algorithm.DiffXAlgorithm;
import com.topologi.diffx.format.DiffXFormatter;
import com.topologi.diffx.format.MultiplexFormatter;
...
// helpers ------------------------------------------------------------------------------------
   ...
   * 
   * @param xml1 The first XML to compare with diffex.
   * @param xml2 The first XML to compare with diffex.
  ...
  /**
   * Asserts that the diffex operation went right.
   * 
   * @param text1 The first XML to compare with diffex.
   * @param text2 The first XML to compare with diffex.
   * @param exp  The expected result as formatted by the TestFormatter.
   * 
   * @throws IOException    Should an I/O exception occur.
   * @throws DiffXException Should an error occur while parsing XML.
